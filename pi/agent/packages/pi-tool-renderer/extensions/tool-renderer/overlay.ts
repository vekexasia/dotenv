export const TOOL_RENDER_OVERLAY_CHECK_SYMBOL = Symbol.for("kendex.pi-tool-renderer.overlay-check");
...
export function floatingOverlayActive(context: any): boolean {
	...
	const lock = (globalThis as unknown as Record<PropertyKey, unknown>)[KENDEX_MODAL_LOCK_SYMBOL] as kendexModalLock | undefined;
