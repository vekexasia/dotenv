...
function readImageRenderState(context: any): ReadImageRenderState {
	...
	if (!record.kendexReadImages || typeof record.kendexReadImages !== "object") {
		record.kendexReadImages = { entries: new Map<number, ReadImageCacheEntry>() };
	}
	return record.kendexReadImages as ReadImageRenderState;
}
