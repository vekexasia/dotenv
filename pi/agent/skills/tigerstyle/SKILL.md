...
When the scope contains TypeScript or JavaScript, apply this section in addition to the generic rules above. It overrides only rules whose implementation depends on the language or runtime.
...
Derived from [TigerBeetle's TigerStyle](https://github.com/tigerbeetle/tigerbeetle/blob/main/docs/TIGER_STYLE.md). The TypeScript and JavaScript adaptations were informed by [M64GitHub/tiger-style](https://github.com/M64GitHub/tiger-style).
